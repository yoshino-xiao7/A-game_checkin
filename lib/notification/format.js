...
export function buildAccountCardData(accounts) {
  const statusMeta = {
...
export function buildGameCardData(targets) {
...
export function buildHelpCardData(communities = []) {
